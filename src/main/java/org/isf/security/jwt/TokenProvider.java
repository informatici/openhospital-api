...
public class TokenProvider implements Serializable {
    ...
    public boolean validateToken(String token) {
        try {
            ...
            log.error("JWT string is a JWE and decryption fails: {}", e.getMessage());
        } catch (SignatureException e) {
            log.error("JWS signature was discovered, but could not be verified: {}", e.getMessage());
            ...
            log.error("JWT generic exception: {}", e.getMessage());        
        }
        return false;
    }
}
