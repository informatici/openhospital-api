...
public class UserController {
	...
	public List<UserGroupDTO> getUserGroup() throws OHServiceException {
	...
	public Boolean updateUserGroup(@Valid @RequestBody UserGroupDTO userGroupDTO) throws OHServiceException {
